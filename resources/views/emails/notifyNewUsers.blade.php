...
<head>
    ...
    <title>Edo State IGR – Land</title>
    <style type="text/css">
        body {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:20px;color:#1A54BA;'><span class="font">Welcome To Happy Parrot!</span> </p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td valign='top' align='center'>
                                                                <div class="contentEditableContainer contentImageEditable">
                                                                    <div class="contentEditable">
                                                                        <img src="{{ asset('mail_template/images/line.png') }}" width='251' height='43' alt='' data-default="placeholder" data-max-width="560">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <h2 >Hello {{ ucfirst($content['fullname']) }}!</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p >
                                                                            Welcome to Happy Parrot! Please confirm your email by
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <a target='_blank' href="{{url('register/verify/'.$content['confirmation_code'])}}" class='link2' style='color:#ffffff;'>Confirm Email</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                        <span style='font-weight:bold;'>Need help? Please send all requests to hello@happy-parrot.com</span>
                                                                                        <br>
                                                                                        Happy Customer, Happy Parrot
                                                                                        <br>
                                                                                        {{--<a target='_blank' href="[FORWARD]">Forward to a friend</a><br>--}}
                                                                                        <a target="_blank" class='link1' class='color:#382F2E;' href="">Powered by Techie Solutions (c) 2018</a>
                                                                                        <br>
                                                                                        {{--<a target='_blank' class='link1' class='color:#382F2E;' href="">(c) 2018</a>--}}
                                                                                    </p>
                                                                                </div>
                                                                            </div></td>
